...
Hows: [
	...
	#VersionObject & {
		keys: polarization?: string //TODO verify if this is only "H" | "V"
...
methodMap: {
	for v in vs {
		"\(v)": or([ for m in Methods if list.Contains(m.versions, v) {m.name}])
	}
}
Methods: [
	#VersionEnum & {
